(function () {
	...
	__vue_render__._withStripped = true;
	  ...
	  function __vue_normalize__(
	    ...
	    component.__file = "/home/admin123/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/PostAction.vue";
	...
	__vue_render__$1._withStripped = true;
	  ...
	  function __vue_normalize__$1(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/admin123/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/PostComment.vue";
	...
	__vue_render__$2._withStripped = true;
	  ...
	  function __vue_normalize__$2(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/admin123/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/PostDropdownMenu.vue";
	...
	__vue_render__$3._withStripped = true;
	  ...
	  var __vue_inject_styles__$3 = function (inject) {
	    if (!inject) { return }
	    inject("data-v-0dc0672c_0", { source: ".post-comments[data-v-0dc0672c] {\n  padding: 15px 46px;\n  padding-top: 0px;\n  background: #F6F6F6;\n}\n.indicator[data-v-0dc0672c] {\n  margin-left: 15px;\n}\n.fade-enter-active[data-v-0dc0672c],\n.fade-leave-active[data-v-0dc0672c] {\n  transition: opacity 0.8s;\n}\n.fade-enter[data-v-0dc0672c],\n.fade-leave-to[data-v-0dc0672c] {\n  opacity: 0;\n}\n", map: {"version":3,"sources":["Post.vue"],"names":[],"mappings":"AAAA;EACE,kBAAkB;EAClB,gBAAgB;EAChB,mBAAmB;AACrB;AACA;EACE,iBAAiB;AACnB;AACA;;EAEE,wBAAwB;AAC1B;AACA;;EAEE,UAAU;AACZ","file":"Post.vue","sourcesContent":[".post-comments {\n  padding: 15px 46px;\n  padding-top: 0px;\n  background: #F6F6F6;\n}\n.indicator {\n  margin-left: 15px;\n}\n.fade-enter-active,\n.fade-leave-active {\n  transition: opacity 0.8s;\n}\n.fade-enter,\n.fade-leave-to {\n  opacity: 0;\n}\n"]}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$3 = "data-v-0dc0672c";
	  /* module identifier */
	  ...
	  function __vue_normalize__$3(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/admin123/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/Post.vue";
	...
	__vue_render__$4._withStripped = true;
	  ...
	  var __vue_inject_styles__$4 = function (inject) {
	    if (!inject) { return }
	    inject("data-v-4870a35c_0", { source: "@keyframes load-data-v-4870a35c {\n0% {\n    background-position: -100px;\n}\n40%,\n  100% {\n    background-position: 500px;\n}\n}\n.post-skeleton[data-v-4870a35c] {\n  height: 250px;\n  border-radius: 4px;\n  max-width: 600px;\n  border: 1px solid #ededed;\n  margin-bottom: 15px;\n}\n.post-skeleton .post-skeleton-body[data-v-4870a35c] {\n  padding: 15px;\n}\n.post-skeleton .post-skeleton-body .user-name[data-v-4870a35c] {\n  height: 10px;\n  width: 100px;\n  margin-left: 5px;\n}\n.post-skeleton .post-skeleton-body .content[data-v-4870a35c] {\n  height: 100px;\n  margin: 15px 0 0 46px;\n}\n.post-skeleton .post-skeleton-body .user-name[data-v-4870a35c],\n.post-skeleton .post-skeleton-body .avatar[data-v-4870a35c],\n.post-skeleton .post-skeleton-body .content[data-v-4870a35c] {\n  background-image: linear-gradient(90deg, #f8f8f8 0px, #fcfcfc 40px, #f8f8f8 80px);\n  background-size: 600px;\n  border-radius: 4px;\n  animation: load-data-v-4870a35c 3s infinite linear;\n}\n.post-skeleton .post-skeleton-foot[data-v-4870a35c] {\n  width: 100%;\n  height: 40px;\n  background: #f8f8f8;\n}\n", map: {"version":3,"sources":["PostSkeleton.vue","/home/admin123/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/PostSkeleton.vue"],"names":[],"mappings":"AAAA;AACE;IACE,2BAA2B;AAC7B;AACA;;IAEE,0BAA0B;AAC5B;AACF;AACA;EACE,aAAa;EACb,kBAAkB;EAClB,gBAAgB;ECClB,yBAAA;EACA,mBAAA;AACA;ADCA;ECCA,aAAA;AACA;AACA;EACA,YAAA;EDCE,YAAY;ECCd,gBAAA;AACA;AACA;EACA,aAAA;EDCE,qBAAqB;ACCvB;AACA;;;EAGA,iFAAA;EACA,sBAAA;EACA,kBAAA;EACA,kDAAA;AACA;AACA;EACA,WAAA;EACA,YAAA;EACA,mBAAA;AACA","file":"PostSkeleton.vue","sourcesContent":["@keyframes load {\n  0% {\n    background-position: -100px;\n  }\n  40%,\n  100% {\n    background-position: 500px;\n  }\n}\n.post-skeleton {\n  height: 250px;\n  border-radius: 4px;\n  max-width: 600px;\n  border: 1px solid #ededed;\n  margin-bottom: 15px;\n}\n.post-skeleton .post-skeleton-body {\n  padding: 15px;\n}\n.post-skeleton .post-skeleton-body .user-name {\n  height: 10px;\n  width: 100px;\n  margin-left: 5px;\n}\n.post-skeleton .post-skeleton-body .content {\n  height: 100px;\n  margin: 15px 0 0 46px;\n}\n.post-skeleton .post-skeleton-body .user-name,\n.post-skeleton .post-skeleton-body .avatar,\n.post-skeleton .post-skeleton-body .content {\n  background-image: linear-gradient(90deg, #f8f8f8 0px, #fcfcfc 40px, #f8f8f8 80px);\n  background-size: 600px;\n  border-radius: 4px;\n  animation: load 3s infinite linear;\n}\n.post-skeleton .post-skeleton-foot {\n  width: 100%;\n  height: 40px;\n  background: #f8f8f8;\n}\n","<template>\n\t<div class=\"post-skeleton flex-column justify-between\">\n\t\t<div class=\"post-skeleton-body\">\n\t\t\t<div class=\"flex\">\n\t\t\t\t<div class=\"avatar avatar-medium\"></div>\n\t\t\t\t<div class=\"user-name\"></div>\n\t\t\t</div>\n\t\t\t<div class=\"content\"></div>\n\t\t</div>\n\t\t<div class=\"post-skeleton-foot\"></div>\n\t</div>\n</template>\n<style lang=\"less\" scoped>\n@base-color: #f8f8f8;\n@shine-color: #fcfcfc;\n@animation-duration: 3s;\n\n@keyframes load {\n\t0% {\n\t\tbackground-position: -100px\n\t}\n\n\t40%, 100% {\n\t\tbackground-position: 500px\n\t}\n}\n\n.background-img() {\n\tbackground-image: linear-gradient(90deg, @base-color 0px, @shine-color 40px, @base-color 80px);\n\tbackground-size: 600px\n}\n.post-skeleton {\n\theight: 250px;\n\tborder-radius: 4px;\n\tmax-width: 600px;\n\tborder: 1px solid #ededed;\n\tmargin-bottom: 15px;\n\t.post-skeleton-body {\n\t\tpadding: 15px;\n\t\t.user-name {\n\t\t\theight: 10px;\n\t\t\twidth: 100px;\n\t\t\tmargin-left: 5px;\n\t\t}\n\t\t.content {\n\t\t\theight: 100px;\n\t\t\tmargin: 15px 0 0 46px;\n\t\t}\n\t\t.user-name, .avatar, .content {\n\t\t\t.background-img();\n\t\t\tborder-radius: 4px;\n\t\t\tanimation: load @animation-duration infinite linear;\n\t\t}\n\t}\n\t.post-skeleton-foot {\n\t\twidth: 100%;\n\t\theight: 40px;\n\t\tbackground: @base-color;\n\t}\n}\n</style>"]}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$4 = "data-v-4870a35c";
	  /* module identifier */
	  ...
	  function __vue_normalize__$4(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/admin123/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/PostSkeleton.vue";
	...
	__vue_render__$5._withStripped = true;
	  ...
	  function __vue_normalize__$5(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/admin123/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/PostLoader.vue";
	...
	__vue_render__$6._withStripped = true;
	  ...
	  function __vue_normalize__$6(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/admin123/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/PostSidebar.vue";
	...
	__vue_render__$7._withStripped = true;
	  ...
	  function __vue_normalize__$7(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/admin123/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/ActivitySidebar.vue";
	...
	__vue_render__$8._withStripped = true;
	  ...
	  function __vue_normalize__$8(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/admin123/frappe-bench/apps/frappe/frappe/public/js/frappe/social/pages/Wall.vue";
	...
	__vue_render__$9._withStripped = true;
	  ...
	  var __vue_inject_styles__$9 = function (inject) {
	    if (!inject) { return }
	    inject("data-v-2f4861da_0", { source: ".profile-sidebar[data-v-2f4861da] {\n  padding: 10px 10px 0 0;\n}\n.user-details[data-v-2f4861da] {\n  min-height: 150px;\n}\n.user-details .location[data-v-2f4861da],\n.user-details .interest[data-v-2f4861da] {\n  margin-bottom: 10px;\n}\n.user-details .location i[data-v-2f4861da],\n.user-details .interest i[data-v-2f4861da] {\n  width: 15px;\n}\n.edit-profile-link[data-v-2f4861da] {\n  margin-top: 15px;\n}\n", map: {"version":3,"sources":["ProfileSidebar.vue"],"names":[],"mappings":"AAAA;EACE,sBAAsB;AACxB;AACA;EACE,iBAAiB;AACnB;AACA;;EAEE,mBAAmB;AACrB;AACA;;EAEE,WAAW;AACb;AACA;EACE,gBAAgB;AAClB","file":"ProfileSidebar.vue","sourcesContent":[".profile-sidebar {\n  padding: 10px 10px 0 0;\n}\n.user-details {\n  min-height: 150px;\n}\n.user-details .location,\n.user-details .interest {\n  margin-bottom: 10px;\n}\n.user-details .location i,\n.user-details .interest i {\n  width: 15px;\n}\n.edit-profile-link {\n  margin-top: 15px;\n}\n"]}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$9 = "data-v-2f4861da";
	  /* module identifier */
	  ...
	  function __vue_normalize__$9(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/admin123/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/ProfileSidebar.vue";
	...
	__vue_render__$a._withStripped = true;
	  ...
	  function __vue_normalize__$a(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/admin123/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/ProfileBanner.vue";
	...
	__vue_render__$b._withStripped = true;
	  ...
	  function __vue_normalize__$b(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/admin123/frappe-bench/apps/frappe/frappe/public/js/frappe/social/pages/Profile.vue";
	...
	__vue_render__$c._withStripped = true;
	  ...
	  function __vue_normalize__$c(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/admin123/frappe-bench/apps/frappe/frappe/public/js/frappe/social/pages/UserList.vue";
	...
	__vue_render__$d._withStripped = true;
	  ...
	  function __vue_normalize__$d(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/admin123/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/NotFound.vue";
	...
	__vue_render__$e._withStripped = true;
	  ...
	  function __vue_normalize__$e(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/admin123/frappe-bench/apps/frappe/frappe/public/js/frappe/social/components/ImageViewer.vue";
	...
	__vue_render__$f._withStripped = true;
	  ...
	  function __vue_normalize__$f(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/home/admin123/frappe-bench/apps/frappe/frappe/public/js/frappe/social/Home.vue";
